...
async def should_return_error_when_name_is_missing(create_tool, tool_context):
    result = await create_tool(name="", summary="Create product", tool_context=tool_context)
...
async def should_return_error_when_phytosanitary_already_exists(create_tool_with_existing, tool_context):
    result = await create_tool_with_existing(name="Neem Oil", summary="Create Neem Oil", tool_context=tool_context)
...
async def should_create_with_correct_name_when_user_confirms(create_tool, tool_context, captured_create):
    await create_tool(name="Neem Oil", summary="Create Neem Oil", tool_context=tool_context)
...
async def should_return_success_when_user_confirms(create_tool, tool_context):
    result = await create_tool(name="Neem Oil", summary="Create Neem Oil", tool_context=tool_context)
...
@pytest.mark.asyncio
async def should_not_create_when_user_cancels(tool_context, captured_create, create_phytosanitary_func, get_phytosanitary_by_name_func, searcher):
    tool = create_confirm_create_phytosanitary_tool(create_phytosanitary_func, get_phytosanitary_by_name_func, searcher, ask_confirmation_cancel)
    await tool(name="Neem Oil", summary="Create Neem Oil", tool_context=tool_context)
...
@pytest.mark.asyncio
async def should_return_cancelled_when_user_declines(tool_context, create_phytosanitary_func, get_phytosanitary_by_name_func, searcher):
    tool = create_confirm_create_phytosanitary_tool(create_phytosanitary_func, get_phytosanitary_by_name_func, searcher, ask_confirmation_cancel)
    result = await tool(name="Neem Oil", summary="Create Neem Oil", tool_context=tool_context)
...
@pytest.fixture
def create_tool(create_phytosanitary_func, get_phytosanitary_by_name_func, searcher, ask_confirmation_confirm):
...
@pytest.fixture
def create_tool_with_existing(create_phytosanitary_func, existing_phytosanitary_func, searcher, ask_confirmation_confirm):
    return create_confirm_create_phytosanitary_tool(
        create_phytosanitary_func=create_phytosanitary_func,
