Feature: Identify bonsai species from a photo

  Scenario: Species is identified from an uploaded photo
    ...
    Then I receive a species identification
  ...
  Scenario: Species identification offers to update the bonsai record
    ...
    And I confirm the photo belongs to bonsai "Desconocido"
    Then I receive a species identification
    And I am offered to update the bonsai record with the identified species
