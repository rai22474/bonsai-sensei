...
APP_NAME = "wiki_dreamer_wikilinks"
...
def create_wikilinks_agent(model: object, wiki_root: Path) -> Agent:
    ...
    return Agent(
        model=model,
        name=APP_NAME,
        instruction=_templates_env.get_template("wikilinks_instruction.jinja2").render(),
