...
from knowledge_base.dreamer.tools import create_list_cards_tool, create_list_wiki_pages_tool, create_read_card_tool
...
def create_cards_agent(model: object, transcripts_root: Path, wiki_root: Path) -> Agent:
