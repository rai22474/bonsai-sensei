...
from bonsai_sensei.metrics import LLM_REQUEST_DURATION, LLM_REQUESTS_TOTAL, LLM_TOKENS_TOTAL
...
def get_cloud_orchestrator_model_factory():
    def factory():
        model_name = os.getenv("GEMINI_ORCHESTRATOR_MODEL", "gemini-3-flash-preview") or None
