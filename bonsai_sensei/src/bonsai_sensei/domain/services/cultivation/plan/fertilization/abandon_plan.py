...
_DOCSTRING = """Abandon the active fertilization plan for a bonsai after explicit user confirmation. Marks the plan as abandoned, records the reason, deletes all future scheduled work from this plan, and updates the wiki page.
...
def create_abandon_fertilization_plan_tool(
    ...
    return create_abandon_plan_tool(
        tool_name="abandon_fertilization_plan",
