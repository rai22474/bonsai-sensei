...
async def execute_apply_fertilizer(
    bonsai_name: str,
    fertilizer_name: str,
    amount: str,
    ...
    """Core fertilizer application logic shared by the ADK tool and direct Telegram commands."""
    ...
    confirmed = await ask_confirmation(
        build_confirmation_message(bonsai_name, fertilizer_name, amount),
        user_id=user_id,
...
def create_apply_fertilizer_tool(
    ...
    async def apply_fertilizer(
        ...
        return await execute_apply_fertilizer(
