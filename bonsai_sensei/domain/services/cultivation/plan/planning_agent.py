...
def create_planning_agent(
    ...
    confirm_create_fertilizer_application_tool: Callable | None = None,
    confirm_create_phytosanitary_application_tool: Callable | None = None,
    confirm_create_transplant_tool: Callable | None = None,
    ...
    direct_tools = [
        ...
        for tool in [
            ...
            confirm_create_fertilizer_application_tool,
            confirm_create_phytosanitary_application_tool,
            confirm_create_transplant_tool,
