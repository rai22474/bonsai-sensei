...
async def schedule_work(
    ...
    if scheduled_date:
        return await run_puntual_func(bonsai_name=bonsai_name, scheduled_date=scheduled_date, **product_extra, tool_context=tool_context)
    ...
    if choice == options[0]:
        return await run_puntual_func(bonsai_name=bonsai_name, scheduled_date="", **product_extra, tool_context=tool_context)
