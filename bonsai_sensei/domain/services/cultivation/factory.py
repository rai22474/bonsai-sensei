...
from bonsai_sensei.domain.services.cultivation.plan.kikaru import (
    create_kikaru,
)
...
def create_cultivation_group(
    ...
    return botanist, weather_agent, kikaru
...
def _create_kikaru(
    ...
    manage_phytosanitary_plan_tool, abandon_phytosanitary_plan_tool,
